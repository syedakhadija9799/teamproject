...
$query="update  userregistration set firstname=?,lastname=?,gender=?,contactno=?,updationDate=? where userid=?";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('sssisi',$fname,$lname,$gender,$contactno,$udate,$aid);
$stmt->execute();
...
$aid=$_SESSION['id'];
$udate = date('d-m-Y h:i:s', time());
	$ret="select * from userregistration where userid=?";
