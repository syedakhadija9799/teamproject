									...
									<div class="col-md-4">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												<div class="stat-panel text-center">
<?php
$result1 ="SELECT count(*) FROM blog ";
...
?>												
													...
													<div class="stat-panel-title text-uppercase">Total Blogs </div>
												</div>
											</div>
											<a href="manage-blog.php" class="block-anchor panel-footer text-center">See All &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-4">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
<?php
$result2 ="SELECT count(*) FROM rating ";
...
?>												
													...
													<div class="stat-panel-title text-uppercase">Total Rating</div>
												</div>
											</div>
											<a href="manage-rating.php" class="block-anchor panel-footer text-center">See All &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
