...
<div class="w3l-homeblock2 w3l-homeblock5 py-5">
    <div class="container pt-md-4 pb-md-5">
        ...
        <p class="mb-sm-5 mb-4 max-width"> “ Beauty begins the moment you decide to be yourself.”</p>
        <section>
        <div class="row">
            <div class="col mt-4">          
                <div class="bg-clr-white hover-box">
                    ...
                    <?php	
//$aid=$_SESSION['id'];
$ret="select * from posted_blog where blog_cat='beauty' ";
...
while($row=$res->fetch_object())
     ...
     ?>                   
                        ...
                        <div class="col-sm-7 card-body blog-details align-self">
                            <a href="beauty2.php?blog_title=<?php echo $row->blog_title;?>" class="blog-desc"><?php echo $row->blog_title;?>
      </a>&nbsp;&nbsp;
