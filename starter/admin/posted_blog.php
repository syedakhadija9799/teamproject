...
$emailid=$_POST['email'];
	$result ="SELECT count(*) FROM userregistration WHERE email=? || userid=?";
...
if($count>0)
{
echo"<script>alert('Registration number or email id registered.');</script>";
}else
{
...
$query1="insert into  rating(regNo,firstName,middleName,lastName,gender,contactNo,email,password) values(?,?,?,?,?,?,?,?)";
